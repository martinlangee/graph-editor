...
namespace GraphEditor.Nodes.StartUpWarning
{
    public class StartUpWarning : NodeDataBase
    {
            ...
            : base(nodeTypeData, onActiveChanged, canBeDeactivated)
        {
            ...
            Ins.Add(new ConnectorData("Tap forward", 3, false, true, onActiveChanged, canBeDeactivated));
            ...
            Outs.Add(new ConnectorData("Backward active", 2, true, true, onActiveChanged, canBeDeactivated));
            Outs.Add(new ConnectorData("Startup active", 3, true, true, onActiveChanged, canBeDeactivated));
